...
def cargar_datos():
    data = {
        ...
        'Costo_Real': [27675455.95, 8542304.05, 29567437.23, 48143596.15, 42377914.45, 3356155.95, 57268916.96, 32374254.54, 
        ...
        'Duracion_Estimada': [589, 698, 313, 692, 191, 686, 272, 430, 280, 417, 412, 612, 360, 387, 681, 312, 423, 493, 654, 442,
        ...
        'Duracion_Real': [579, 682, 369, 665, 252, 722, 278, 460, 279, 500, 458, 662, 372, 392, 680, 308, 470, 579, 673, 481,
        ...
        'Materiales': [3965, 2560, 13869, 7563, 1559, 16882, 11828, 16898, 18240, 11955, 19944, 19668, 19166, 7125, 16094,
        ...
        'Mano_Obra': [76335, 59766, 73323, 48942, 27369, 41119, 45890, 36608, 42422, 95058, 9443, 6004, 96820, 79035, 37616,
...
with col2:
    if 'retraso_sim' in st.session_state:
        ...
        if retraso <= 0:
            ...
            st.balloons()
            recomendacion = "✅ Proyecto entregará a tiempo. Mantener planificación."
        elif retraso <= 30:
            ...
            recomendacion = "🔴 ALTO RIESGO. Aumentar mano de obra 20% y proteger del clima."
...
st.markdown("---")
st.caption("✅ Dashboard corregido - Sin errores de removeChild")
